...
-- Move between windows using navigation keys
...
-- Center cursor when scrolling buffer up or down
...
-- Appending next line to end of current line keeps cursor position
vim.keymap.set("n", "J", "mzJ`z")

-- Keeps pasted text in register after pasting
